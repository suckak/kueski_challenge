...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _flowReducer = __webpack_require__(203);

	var _flowReducer2 = _interopRequireDefault(_flowReducer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var INITIAL_STATE = {
	    ...
	    campaigns: null,
	    user: null,
	    unseen: APP_DATA.tweets.map(function (tweet) {
	        return tweet._id;
	    })
	};
	...
	var dataReducer = function dataReducer() {
	    ...
	    switch (action.type) {
	        case _constants.actionTypes.GET_TWEETS:
	            return _extends({}, state, {
	                tweets: APP_DATA.tweets
	            });
	            break;
	        case _constants.actionTypes.GET_CAMPAIGNS:
	            return _extends({}, state, {
	                campaigns: APP_DATA.campaigns
	            });
	            break;
	        case _constants.actionTypes.GET_USER:
	            return _extends({}, state, {
	                user: APP_DATA.user
	            });
	            break;
	        case _constants.actionTypes.MARK_TWEET:
	            var unseen = state.unseen.filter(function (id) {
...
/***/ (function(module, exports) {
	...
	var appSections = exports.appSections = {
	    start: {
	        id: 0,
	        name: 'INICIO'
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var INITIAL_STATE = {
	    section: _constants.appSections.start,
	    selectedTweet: null,
	    title: _constants.appSections.start.name
	};
	...
	var flowReducer = function flowReducer() {
	    ...
	    switch (action.type) {
	        case _constants.actionTypes.CHANGE_SECTION:
	            return _extends({}, state, {
	        ...
	        case _constants.actionTypes.SELECT_TWEET:
	            return _extends({}, state, {
	                selectedTweet: action.payload
	            });
	            break;

	        case _constants.actionTypes.SET_TITLE:
	            return _extends({}, state, {
